...
import MenuMedico from '../../components/menuMedico/MenuMendico';
        ...
        <div className={style.menuTotal}>
            ...
            <div className={style.menuConteudo}>
                <div className={style.secaoBotao}>
                    ...
                    <Botao text='Menu Medico' icon={<IoIosAddCircleOutline />} onClick={toggleModal5}/>
                </div>
            ...
            <MenuMedico isOpen={modalOpen5} onClose={toggleModal5}/>
        </div>
